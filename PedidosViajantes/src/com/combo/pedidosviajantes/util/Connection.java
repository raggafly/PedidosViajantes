...
public class Connection {
	...
	public boolean ftpConnect(String host, String username, String password,
		...
		try {
			...
			mFTPClient.connect(InetAddress.getByName(host), 21);
	...
	public String getUrlFile(String nameBusinessTraveler, String nameFile) {
		String url = "pedidosViajantes/HistoricoPDF/" + nameBusinessTraveler
				+ "/";
		pathUrlDelete = url + nameFile;
		// url = url + nameBusinessTraveler + "/";
		url = "www.decoracionessantander.com/" + url + nameFile;
		return url;
	}
}
